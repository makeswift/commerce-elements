...
export function Button({
  ...
  return (
    <button
      ...
      aria-busy={loading}
      className={clsx(
        'font-body relative z-0 inline-flex h-fit select-none items-center justify-center overflow-hidden border text-center font-semibold leading-normal after:absolute after:inset-0 after:-z-10 after:-translate-x-[105%] after:transition-[opacity,transform] after:duration-300 after:ease-[cubic-bezier(0,0.25,0,1)] focus-visible:outline-2 focus-visible:outline-[var(--button-focus,hsl(var(--primary)))] disabled:pointer-events-none disabled:opacity-30',
        {
          primary:
